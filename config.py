...
wallet_wallet_commands = ['new_wallet', 'lock', 'unlock', 'set_password', 'import_key', 'getPrivateKeyForPublicKey', 'getAccountFromPublicKey', 'list_my_accounts', 'suggest_brain_key']
wallet_chain_commands = ['info', 'get_object']
...
no_params_commands = ["lock", "list_my_accounts", "suggest_brain_key", "info"]
one_params_commands = ["new_wallet", "getAccountFromPublicKey", "import_key", "getPrivateKeyForPublicKey", "unlock", "set_password", "get_object", "get_account", "get_asset", "list_account_balances", "get_contract"]
two_params_commands = ["get_account_history"]
three_params_commands = ["update_collateral_for_gas"]
